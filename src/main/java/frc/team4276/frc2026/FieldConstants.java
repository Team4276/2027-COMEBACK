...
public class FieldConstants {
    ...
    public static class LinesVertical {
        ...
        public static final double hubCenter = apriltagLayout.getTagPose(26).get().getX()
                + Hub.width / 2.0;
        ...
        public static final double oppHubCenter = apriltagLayout.getTagPose(4).get().getX()
                + Hub.width / 2.0;
        public static final double oppAllianceZone = apriltagLayout.getTagPose(10).get()
                .getX();
    }
    ...
    public static class Outpost {
        ...
        public static final Translation2d centerPoint = new Translation2d(0,
                apriltagLayout.getTagPose(29).get().getY());
    }
